...
var Helpers = {
  ...
  confirm: function confirm(title, callback) {
    Swal.fire({
      title: title,
      icon: "question",
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _context.next = 3;
              return Helpers.request("DELETE", "/posts/".concat(id));

            case 3:
              data = _context.sent;
              select(".table__posts tr[id=\"".concat(id, "\"]")).remove();
              _context.next = 10;
              break;
...
var App = {
  events: function events() {
    Event(".btn-remove__post").add("click", function (_ref) {
...
__webpack_require__(/*! /var/www/laravel/cms/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /var/www/laravel/cms/resources/css/app.css */"./resources/css/app.css");
